  ...
  sections: [
    {
      ...
      description:
        "Introducing Didact. Why sometimes it's a good idea to reinvent the wheel and how re-writing main features is easier than it sounds.",
    ...
    },
    {
      ...
      description:
        "We add React's most basic feature: rendering elements to the DOM. We include element properties, event listeners and children.",
    ...
    },
    {
      ...
      description:
        "We include some syntactic sugar with JSX and provide a less verbose way to define elements.",
    ...
    },
    {
      ...
      description:
        "The more complex part of React is the virtual DOM and the reconciliation algorithm. We add our own version to Didact:",
    ...
    },
    {
      ...
      description:
        "Finally, with everything else put in place, we add components to Didact and cover a big part of React use cases.",
