...
export default {
  ...
  sections: [
    ...
    //     },
    {
      title: "Markov Chains",
      description:
        "Markov chains are a simple but powerful models. One of the things you can do with them is automatic text generation. The Markov chain algorithm that Sanata uses is now available as an NPM package.",
    ...
    },
    {
      ...
      blog: {
        ...
        url:
          "https://medium.com/hexacta-engineering/automatic-deployment-of-multiple-docker-containers-to-google-container-engine-using-travis-e5d9e191d5ad",
